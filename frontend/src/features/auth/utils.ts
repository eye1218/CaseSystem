...
export function hasMenuAccess(role: RoleCode, menuItem: string): boolean {
  const accessMatrix: Record<RoleCode, string[]> = {
    T1: ["dashboard", "tickets", "slaMonitor", "notifications", "knowledge", "tasks", "reports"],
    T2: ["dashboard", "tickets", "slaMonitor", "notifications", "knowledge", "tasks", "reports", "kpi"],
    T3: ["dashboard", "tickets", "slaMonitor", "notifications", "knowledge", "tasks", "reports", "kpi"],
    ADMIN: ["dashboard", "tickets", "slaMonitor", "notifications", "knowledge", "events", "tasks", "reports", "kpi", "configuration", "users", "audit", "recycle"],
